    ...
    return (
        <div className="section">
            <div className="section__adBanner">
                ...
                <h2 className="section__adBanner__about">
                    Witamy na stronie poświęconej środkom anabolicznym.{" "}
                </h2>
            </div>
            <div className="section__about">
                <h2 className="section__about__header">
                    PRODUKTY, SPRAWDZONE <br /> PRZEZ SPORTOWCÓW
                </h2>
                <div className="section__about__container">
                    <div className="section__about__container__element">
                        ...
                        <p className="section__about__container__text">
                    ...
                    <div className="section__about__container__element">
                        ...
                        <p className="section__about__container__text">
                            Oferujemy nie tylko szeroką gamę środków
                            anabolicznych i produktów pochodzenia aptecznego ale
                            również wsparcie w doborze środków i ich dawkowania,
                            czy chociażby rady odnośnie prawidłowego
                            przeprowadzenia PCT (post cycle therapy) potocznie
                            zwanego odblokiem.{" "}
                        </p>
                    </div>
                    <div className="section__about__container__element">
                        ...
                        <p className="section__about__container__text">
                            Naszymi klientami są nie tylko normalni użytkownicy
                            siłowni i pasjonaci sportów ale również wyczynowi
                            sportowcy.{" "}
                        </p>
                    </div>
                </div>
