const data = {
  ...
  rows: [
    ...
    {
      name: 'Tamoxifen Citrate (Nolvadex) - Virtutis Pharma',
      weight: '30tab / 20mg',
      price: 60,
      brand: 'Pozostale',
      type: 'Pozostale',
    ...
    {
      name: 'Clomifene Citrate (Cłomtd) - Virtutis Pharma',
      weight: '30tab / 50mg',
      price: 70,
      brand: 'Pozostale',
      type: 'Pozostale',
    ...
    {
      name: 'Masterolon (Proviron) - Virtutis Pharma',
      weight: '20tab / 25mg',
      price: 50,
      brand: 'Pozostale',
      type: 'Pozostale',
